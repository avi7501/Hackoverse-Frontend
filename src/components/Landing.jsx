  ...
  return (
    <>
      <ToastContainer
        ...
        pauseOnHover
      />
 {/* <div className="flex p-3 justify-center items-center text-4xl font-bold font-poppins">Compiler</div> */}
      ...
      <div className="flex flex-row space-x-4 items-start px-4 py-2 h-[80%] ">
        <div className="flex flex-col w-full h-full justify-start text-white items-end">
          <CodeEditorWindow
            code={code}
            onChange={onChange}
